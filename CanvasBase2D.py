...
class CanvasBase2D(glcanvas.GLCanvas):
    """
    ...
    __pixelScale: int = 1
    __quadric: object = glu.gluNewQuadric()
    __background: ColorType = ColorType(0, 0, 0)
    ...
    def __init__(self, parent: wx.Frame) -> None:
        ...
        """
        super(CanvasBase2D, self).__init__(parent)
        self.init = False
