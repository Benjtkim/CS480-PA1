...
class Buff:
    ...
    """
    buff: np.ndarray | None = None
    buffPointArray: list[list[Point]] | None = None
    size: tuple[int, int] | None = None
    width: int | None = None
    height: int | None = None
    background_color: ColorType | None = None

    def __init__(self, width: int = 0, height: int = 0, color: ColorType | None = None) -> None:
        """
    ...
    def clear(self) -> None:
        ...
        :rtype: None
        """
        self.buff[:] = self.background_color.getRGB_8bit()
    ...
    def getPoint(self, x: int, y: int) -> Point | bool:
        """
    ...
    def getPixel(self, x: int, y: int) -> np.ndarray:
        """
    ...
    def setStaticBuffArray(self, buffArray: np.ndarray) -> None:
        """
    ...
    def generatePointArray(self) -> None:
        """
    ...
    def _setBuffArray(self, buffarray: np.ndarray) -> None:
        """
        In class usage only
        """
